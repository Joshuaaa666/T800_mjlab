...
def run_train(task_id: str, cfg: TrainConfig, log_dir: Path) -> None:
  ...
  if cfg.video:
    # Neighbor env copies can fully occlude the semi-transparent ghost at large num_envs.
  ...
  if cfg.video and rank == 0:
    from src.viewer.offscreen_renderer import patch_offscreen_renderer_for_ghost

    patch_offscreen_renderer_for_ghost(env)
