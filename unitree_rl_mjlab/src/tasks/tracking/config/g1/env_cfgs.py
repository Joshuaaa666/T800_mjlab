...
from src.tasks.tracking.tracking_env_cfg import make_tracking_env_cfg_base
from src.tasks.tracking.tracking_standing_env_cfg import (
  make_tracking_standing_env_cfg_base,
)
from src.tasks.tracking.tracking_standing_env_cfg import (
  make_tracking_standing_env_cfg_1307_stage_I_base,
  make_tracking_standing_env_cfg_1307_stage_II_base,
  make_tracking_standing_env_cfg_1307_stage_III_base,
)
...
def unitree_g1_flat_tracking_standing_env_cfg_1307_stage_I(
  ...
  cfg = make_tracking_standing_env_cfg_1307_stage_I_base()
  for name, func, params in cfg.terminations["tracking_failure"].func.terms:
    if name == "ee_body_pos_z":
        params["body_names"] = (
            "left_ankle_roll_link",
...
def unitree_g1_flat_tracking_standing_env_cfg_1307_stage_II(
  ...
  cfg = make_tracking_standing_env_cfg_1307_stage_II_base()
  cfg = _post_process_unitree_g1_flat_tracking_standing_env_cfg(cfg, has_state_estimation, play)
  return cfg
...
def unitree_g1_flat_tracking_standing_env_cfg_1307_stage_III(
  ...
  cfg = make_tracking_standing_env_cfg_1307_stage_III_base()
  cfg = _post_process_unitree_g1_flat_tracking_standing_env_cfg(cfg, has_state_estimation, play)
  return cfg